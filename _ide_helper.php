 ...
 * Generated for Laravel 5.1.24 (LTS) on 2015-12-08.
 *
...
namespace {
    ...
    class Markdown extends \VTalbot\Markdown\Facades\Markdown{
        ...
        public static function make($markdown){
            return \VTalbot\Markdown\Environment::make($markdown);
        }
         ...
         * @static 
         */
        public static function string($markdown){
            return \VTalbot\Markdown\Environment::string($markdown);
        }
         ...
         */
        public static function incrementRender(){
            \VTalbot\Markdown\Environment::incrementRender();
        }
         ...
         */
        public static function decrementRender(){
            \VTalbot\Markdown\Environment::decrementRender();
        }
         ...
         */
        public static function doneRendering(){
            return \VTalbot\Markdown\Environment::doneRendering();
        }
         ...
         */
        public static function addLocation($location){
            \VTalbot\Markdown\Environment::addLocation($location);
        }
         ...
         */
        public static function addNamespace($namespace, $hints){
            \VTalbot\Markdown\Environment::addNamespace($namespace, $hints);
        }
         ...
         */
        public static function addExtension($extension, $engine, $resolver = null){
            \VTalbot\Markdown\Environment::addExtension($extension, $engine, $resolver);
        }
        
        /**
         * Get the engine resolver instance.
         *
         * @return \VTalbot\Markdown\EngineResolver 
         * @static 
         */
        public static function getEngineResolver(){
            return \VTalbot\Markdown\Environment::getEngineResolver();
        }
        
        /**
         * Get the Markdown finder instance.
         *
         * @return \VTalbot\Markdown\FileViewFinder 
         * @static 
         */
        public static function getFinder(){
            return \VTalbot\Markdown\Environment::getFinder();
        }
        
        /**
         * Get the event dispatcher instance.
         *
         * @return \VTalbot\Markdown\Dispatcher 
         * @static 
         */
        public static function getDispatcher(){
            return \VTalbot\Markdown\Environment::getDispatcher();
        }
        
        /**
         * Get the IoC container instance.
         *
         * @return \VTalbot\Markdown\Container 
         * @static 
         */
        public static function getContainer(){
            return \VTalbot\Markdown\Environment::getContainer();
        }
        
        /**
         * Set the IoC container instance.
         *
         * @param \VTalbot\Markdown\Container $container
         * @return void 
         * @static 
         */
        public static function setContainer($container){
            \VTalbot\Markdown\Environment::setContainer($container);
        }
         ...
         */
        public static function getShared(){
            return \VTalbot\Markdown\Environment::getShared();
        }
